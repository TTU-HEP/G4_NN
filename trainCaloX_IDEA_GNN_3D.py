...
def generator(batch_size,nfiles):
  ...
  df = pd.read_pickle('/home/gvetters/CaloX_Work/IDEA/GNN.pi150GeV_207.pkl.gz') #('/lustre/research/hep/jdamgov/idea_ntpl_v1/IDEA_pi_pkl3_3D_1C_RI1p49_zeroSci_noProp_1cmBS/GNN.pi150GeV_100.pkl.gz')
  ...
  while 1:
    ...
    if counter >= number_of_batches:
        counter = 0
        df = pd.read_pickle('/home/gvetters/CaloX_Work/IDEA/GNN.pi150GeV_207.pkl.gz') #('/lustre/research/hep/jdamgov/idea_ntpl_v1/IDEA_pi_pkl3_3D_1C_RI1p49_zeroSci_noProp_1cmBS/GNN.pi150GeV_'+str(fcnt)+'.pkl.gz')
        df["Label"]=df["Label"]/1000.
        samples_per_file = len(df)
        number_of_batches = int(samples_per_file/batch_size)
